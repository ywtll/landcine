...
public class RoundRectJPasswordField extends RoundPanel {

    private JPasswordField jf;

    public RoundRectJPasswordField(ImageIcon icon, int width, int height, Color bgColor) {
        super(height,height);
    ...
    public RoundRectJPasswordField(int width, int height, Color bgColor) {
