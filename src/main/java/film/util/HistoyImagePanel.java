...
public class HistoyImagePanel extends RoundPanel {

    public HistoyImagePanel(ImageIcon icon, String name, String time, String introduce, int arcWidth, int arcHeight, int width, int height) {
...
//        this.setBackground(Color.red);
        ...
        timeLabel.setBounds(0, height/2-12, 75, 12);
        timeLabel.setFont(new Font("微软雅黑", Font.PLAIN, timeLabel.getHeight()));
        add(timeLabel);
        ...
        imageLabel.setBounds(timeLabel.getWidth() + 20,0,height/3*2,height);
        this.add(imageLabel);
...
//        jf.add(p);
        ...
        HistoyImagePanel p = new HistoyImagePanel(icon1, "齐天大声gyu jkhkjh ghj", "2002-10-29", "这是一部非常好看的电影",20, 20, 600, 200);
        HistoyImagePanel p2 = new HistoyImagePanel(icon2, "齐天大声gyu jkhkjh ghj", "2002-10-29", "这是一部非常好看的电影",20, 20, 600, 200);
